...
<footer id="footer" class="dark-style<?php echo $footer_bg_image; ?>" <?php echo $footer_bg; ?>>
	...
	?>
		...
		<div class="row">
			<div class="col-12">
				<p id="footer-notice">Submitted on behalf of the Broadcasting Board of Governors (now U.S. Agency for Global Media) and pursuant to Section 305(a) of the International Broadcasting Act of 1994 (Public Law 103-236). Because this report covers work completed in 2017, this document will continue to refer to the agency as the BBG.</p>
			</div>
		</div>
	</div>
	<!-- END .container -->
